...
WebUI.sendKeys(findTestObject('OR File Upload/Page_Multiple Uploads Sample/input_Upload multiple_File'), ((dirName + '/Users/wahyurunnianto/Documents/MyDocs/CV_Wahyu Runnianto Adji_pdf.pdf') +
	dirName) + 'MyDocs/CV_Wahyu Runnianto Adji_pdf.pdf')

String filePath = '/Users/wahyurunnianto/Documents/MyDocs/CV_Wahyu Runnianto Adji_pdf.pdf'
